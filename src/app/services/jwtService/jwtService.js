...
import { baseURL, homeUrl } from 'app/fuse-configs/axiosConfig';
...
class jwtService extends FuseUtils.EventEmitter {
  ...
  getProfileData = () => {
    return new Promise((resolve, reject) => {
      axios.get(`${baseURL}/authserv/api/v1/users/profile`).then((response) => {
  ...
  logout = () => {
    return new Promise(async (resolve, reject) => {
      await axios.post(`${baseURL}/authserv/api/v1/logout`).then((response) => {
