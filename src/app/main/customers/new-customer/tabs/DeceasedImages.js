...
function DeceasedImages(props) {
  const { form, handleImageUpload, deleteImage, handleNext, handlePrev, tabValue } = props;
      ...
      <div className="flex justify-center">
        <Card elevation={1} className="w-400">
          ...
          <CardContent className="text-justify">
            <Typography>Deceased image & documents are not needed for services that doesn't require admission</Typography>
          </CardContent>
        </Card>
      </div>
    }
