...
function DeceasedInfo(props) {
  const { form, handleChange, handleDateChange, handleTimeChange, handleNext, handlePrev, tabValue } = props;
      ...
      <Fragment>
        ...
        >
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className='text-lg font-bold'>Deceased Details</Typography>
          </AccordionSummary>
        ...
        >
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className='text-lg font-bold'>Death Assertion</Typography>
          </AccordionSummary>
          <AccordionDetails className='flex flex-col md:flex-row'>
            <div className='w-full h-320'>
              <div className='grid grid-cols-2 gap-x-24'>
        ...
        <div className="flex justify-center">
          <Card elevation={1} className="w-400">
            ...
            <CardContent className="text-justify">
              <Typography>Deceased information is not needed for services that doesn't require admission</Typography>
            </CardContent>
          </Card>
        </div>
      </Fragment>
