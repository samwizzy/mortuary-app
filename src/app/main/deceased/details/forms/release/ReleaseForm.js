...
import { Button, MenuItem, TextField, IconButton, Icon } from '@material-ui/core';
									...
									<dd className='mt-1 sm:grid sm:grid-cols-2 gap-x-8 col-span-2 text-sm text-gray-900 sm:mt-0'>
										...
										<div className="w-full flex space-x-2">
											...
											>
												...
												{['Male', 'Female'].map(sex => <MenuItem key={sex} value={sex}>{sex}</MenuItem>)}	
											</TextField>
										</div>
									</dd>
								</div>	
								...
								<div className='bg-gray-100 px-1 py-1 sm:grid sm:grid-cols-3 items-end sm:gap-4 sm:px-0'>
									...
									<dd className='mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2'>
										<TextField 
											...
											fullWidth 
										>
											<MenuItem value="">Select relationship with deceased</MenuItem>
...
export default withReducer("deceasedApp", reducer)(withRouter(connect(mapStateToProps)(ReleaseForm)));